...
export const showcases: ShowcaseData[] = [
	{
		...
		title: "Scouterna",
		description:
			"The Scouts are a democratic children's and youth organization based on the scout method. The Scouts are non-religious and welcome everyone who can stand behind their core values.",
		content:
			"Scouterna är en demokratisk barn- och ungdomsorganisation som bygger på scoutmetoden. Scouterna är partipolitiskt och religiöst obundna och välkomnar alla som kan ställa sig bakom vår värdegrund.",
		images: [
	...
	},
	{
		...
		title: "Mimbly",
		description:
			"Mimbly is a cleantech company from Gothenburg. Starting in 2023, Mimbly designs and launches its laundry innovations in Gothenburg, Sweden. Their achievements over the years are what propels them from startup to scaleup.",
		content:
			"Mimbly is a cleantech company from Gothenburg. Starting in 2023, Mimbly designs and launches its laundry innovations in Gothenburg, Sweden. Their achievements over the years are what propels them from startup to scaleup.",
		images: [
		...
		timeline: {
			...
			span: {
				end: new Date("2023-01-01").getTime(),
				label: "Sep 2022 - Jan 2023",
			},
			company: "Mimbly",
		},
	...
	},
	{
		...
		title: "I am a game",
		description:
			"I am a game is a game that I created as a Degree Project and to learn Svelte, C#.net and SignalR.",
		content:
			"I am a game is a game that I created as a Degree Project and to learn Svelte, C#.net and SignalR.",
		...
		timeline: {
			...
			span: {
				end: new Date("2021-06-01").getTime(),
				label: "Jan 2021 - Jun 2021",
			},
			company: "I am a game",
		},
	},
	{
		...
		title: "Foodlist",
		description:
			"Foodlist is a web application that helps me keep track of my favorite recipes. I can add recipes, edit them and delete them. I can also change the amount of portions and get an updated list of ingredient amounts.",
		content:
			"Foodlist is a web application that helps me keep track of my favorite recipes. I can add recipes, edit them and delete them. I can also change the amount of portions and get an updated list of ingredient amounts.",
		...
		timeline: {
			...
			span: {
				end: new Date("2022-03-01").getTime(),
				label: "Nov 2021 - Mar 2022",
			},
			company: "Foodlist",
		},
	},
	{
		...
		title: "Scruit",
		description:
			"Scruit is a Kanban board similar to Github Projects. Scruit is my first application that uses drag and drop.",
		content:
			"Scruit is a Kanban board similar to Github Projects. Scruit is my first application that uses drag and drop.",
		...
		timeline: {
			...
			span: {
				end: new Date("2022-04-01").getTime(),
				label: "Jul 2022 - Apr 2022",
			},
			company: "Scruit",
		},
	},
	{
		...
		title: "Todo",
		description:
			"Todo is a todo application that allows multiple lists, saving everything locally.",
		content:
			"Todo is a todo application that allows multiple lists, saving everything locally.",
	...
	},
	{
		...
		description:
			"Frontedge dashboard is a small project for a spare screen at the Frontedge IT office. The dashboard shows the weather, the time, the date and departures from the nearest bus stop in realtime.",
		content:
			"Frontedge dashboard is a small project for a spare screen at the Frontedge IT office. The dashboard shows the weather, the time, the date and departures from the nearest bus stop in realtime.",
